    ...
    private synchronized void processImage(MutableImage mutableImage, ReadableMap options, Promise promise) {
        ...
        switch (options.getInt("target")) {
            ...
            case RCT_CAMERA_CAPTURE_TARGET_CAMERA_ROLL: {
                ...
                resolveImage(cameraRollFile, mutableImage.getWidth(), mutableImage.getHeight(), promise, true);
            ...
            case RCT_CAMERA_CAPTURE_TARGET_DISK: {
                ...
                resolveImage(pictureFile, mutableImage.getWidth(), mutableImage.getHeight(), promise, false);
            ...
            case RCT_CAMERA_CAPTURE_TARGET_TEMP: {
                ...
                resolveImage(tempFile, mutableImage.getWidth(), mutableImage.getHeight(), promise, false);
